...
typedef enum WGPUNativeSType {
  ...
  WGPUSType_DevicePropertiesVulkan = 0x60000006,
  WGPUSType_ExternalSwapchainVulkan = 0x60000007,
...
void wgpuRenderPassEncoderSetPushConstants(WGPURenderPassEncoder encoder, WGPUShaderStageFlags stages, uint32_t offset,
...
void wgpuRenderPassEncoderMultiDrawIndexedIndirect(WGPURenderPassEncoder encoder, WGPUBuffer buffer, uint64_t offset,
                                                   uint32_t count);

void wgpuRenderPassEncoderMultiDrawIndirectCount(WGPURenderPassEncoder encoder, WGPUBuffer buffer, uint64_t offset,
                                                 WGPUBuffer count_buffer, uint64_t count_buffer_offset, uint32_t max_count);
void wgpuRenderPassEncoderMultiDrawIndexedIndirectCount(WGPURenderPassEncoder encoder, WGPUBuffer buffer, uint64_t offset,
...
struct WGPUExternalSwapchainDescriptor {
  WGPUChainedStruct const *nextInChain;
};

void wgpuDeviceGetProperties(WGPUDevice device, WGPUAdapterProperties *properties);
